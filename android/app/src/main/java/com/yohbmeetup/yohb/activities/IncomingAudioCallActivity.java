...
public class IncomingAudioCallActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callType.setText("Incoming Calling");
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.answerButton:
                    ...
                    JitsiMeetActivity.launch(IncomingAudioCallActivity.this, options);
                    finish();
                    break;
